                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="p-4">
                        ...
                        {{--
                            ...
                            Show/hide card UI with v-show based on category === tab.
                            Hidden inputs are ALWAYS in the DOM so all categories submit.
                        --}}
                        <template x-for="drug in drugs" :key="drug._key">
                            <div>
                                ...
                                {{-- Hidden inputs — ALWAYS rendered, not conditional on tab --}}
