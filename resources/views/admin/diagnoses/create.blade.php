@extends('layouts.app')
@section('title', 'New Diagnosis')

@section('content')
<div class="max-w-xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 class="text-base font-semibold text-gray-700 mb-5">New Diagnosis</h2>
        <form method="POST" action="{{ route('admin.diagnoses.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="icd_code" value="{{ old('icd_code') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
            ...
            <div class="flex gap-3 pt-2">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white text-sm px-5 py-2 rounded-lg transition">Save Diagnosis</button>
