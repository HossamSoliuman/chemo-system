        ...
        <form method="POST" action="{{ route('patients.update', $patient) }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    <label class="block text-sm font-medium text-gray-600 mb-1">Serum Creatinine (mg/dL)</label>
                    <input type="number" step="0.001" name="serum_creatinine" value="{{ old('serum_creatinine', $patient->serum_creatinine) }}" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
