        ...
        <aside class="no-print w-64 bg-blue-900 text-white flex flex-col flex-shrink-0">
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                <a href="{{ route('dashboard') }}"
                    class="sidebar-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm hover:bg-blue-700 transition {{ request()->routeIs('dashboard') ? 'bg-blue-700' : '' }}">
                ...
                <a href="{{ route('orders.create') }}"
                    class="sidebar-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm hover:bg-blue-700 transition {{ request()->routeIs('orders.create') ? 'bg-blue-700' : '' }}">
                    <i class="fa-solid fa-file-medical w-5 text-center"></i> New Order
                </a>
                <a href="{{ route('orders.index') }}"
                    class="sidebar-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm hover:bg-blue-700 transition {{ request()->routeIs('orders.*') && !request()->routeIs('orders.create') ? 'bg-blue-700' : '' }}">
                    <i class="fa-solid fa-clipboard-list w-5 text-center"></i> Order History
                </a>
                <a href="{{ route('patients.index') }}"
                    class="sidebar-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm hover:bg-blue-700 transition {{ request()->routeIs('patients.*') ? 'bg-blue-700' : '' }}">
                ...
                <a href="{{ route('admin.protocols.index') }}"
                    class="sidebar-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm hover:bg-blue-700 transition {{ request()->routeIs('admin.protocols.*') ? 'bg-blue-700' : '' }}">
                    <i class="fa-solid fa-flask w-5 text-center"></i> Protocols
                </a>
                <a href="{{ route('admin.diagnoses.index') }}"
                    class="sidebar-link flex items-center gap-3 px-3 py-2 rounded-lg text-sm hover:bg-blue-700 transition {{ request()->routeIs('admin.diagnoses.*') ? 'bg-blue-700' : '' }}">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-2 text-sm" x-data="{ open: false }">
                        ...
                        <button @click="open = !open"
                            class="text-gray-700 hover:text-gray-900 font-medium flex items-center gap-1">
                            {{ auth()->user()->name }}
